...
from fairseq.modules import (
    ...
    TransformerOriginalDecoderLayer,
    TransformerOriginalEncoderLayer,
)
...
@register_model("transformer_original")
class TransformerOriginalModel(FairseqEncoderDecoderModel):
    """
...
#DOES NOT WORK, UPDATE TO THE CORRECT CLASSES- ADITI
@register_model("transformer_align_original")
class TransformerAlignOriginalModel(TransformerOriginalModel):
    """
...
class TransformerEncoder(FairseqEncoder):
    ...
    def build_encoder_layer(self, args):
        return TransformerOriginalEncoderLayer(args)
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        return TransformerOriginalDecoderLayer(args, no_encoder_attn)
...
@register_model_architecture("transformer_original", "transformer_original")
...
@register_model_architecture("transformer_original", "transformer_iwslt_de_en_original")
...
@register_model_architecture("transformer_original", "transformer_wmt_en_de_original")
def transformer_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("transformer_original", "transformer_vaswani_wmt_en_de_big_original")
...
@register_model_architecture("transformer_original", "transformer_vaswani_wmt_en_fr_big_original")
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, "dropout", 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture("transformer_original", "transformer_wmt_en_de_big_original")
...
@register_model_architecture("transformer_original", "transformer_wmt_en_de_big_t2t_original")
...
@register_model_architecture("transformer_align_original", "transformer_align_original")
...
@register_model_architecture("transformer_align_original", "transformer_wmt_en_de_big_align_original")
