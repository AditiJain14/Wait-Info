...
from fairseq.modules import LayerNorm, TransformerOriginalDecoderLayer, TransformerOriginalEncoderLayer

from . import build_monotonic_attention


class TransformerMonotonicEncoderLayer(TransformerOriginalEncoderLayer):
...
class TransformerMonotonicDecoderLayer(TransformerOriginalDecoderLayer):
    def __init__(
