...
from fairseq.models.transformer_original import (
    TransformerDecoder,
    TransformerEncoder,
    TransformerOriginalModel,
    base_architecture,
...
class TransformerUnidirectionalModel(TransformerOriginalModel):
    @classmethod
...
class TransformerMonotonicModel(TransformerOriginalModel):
    @classmethod
    def build_encoder(cls, args, src_dict, embed_tokens):
        return TransformerMonotonicEncoder(args, src_dict, embed_tokens)
